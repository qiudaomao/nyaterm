...
Dragonfly 的终端体验围绕“在同一个工作区里高频处理远程与本地会话”设计。它基于 xterm.js，但实际体验并不只是一块终端画布，还包括搜索、命令历史、建议、AI 辅助、可选增强项、录制和 SSH 辅助能力。
...
Dragonfly 在右侧面板中内置了 **AI Assistant**，并且可以从终端上下文直接唤起。
